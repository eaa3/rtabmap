...
public:
    ...
    void setupUi(QMainWindow *DatabaseViewer)
    {
        ...
        DatabaseViewer->resize(1183, 804);
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 162, 150));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 162, 150));
        ...
        gridLayout_5->addWidget(label_optimizeFrom, 0, 1, 1, 1);
        ...
        page->setGeometry(QRect(0, 0, 314, 303));
        ...
        page_2->setGeometry(QRect(0, 0, 338, 314));
        ...
        page_3->setGeometry(QRect(0, 0, 246, 198));
        ...
        gridLayout_7->addWidget(comboBox_graphOptimizer, 0, 0, 1, 1);
        ...
        gridLayout_7->addWidget(spinBox_iterations, 1, 0, 1, 1);
        ...
        gridLayout_7->addWidget(spinBox_optimizationDepth, 2, 0, 1, 1);
        ...
        gridLayout_7->addWidget(checkBox_ignoreCovariance, 3, 0, 1, 1);

        label_34 = new QLabel(page_3);
        label_34->setObjectName(QString::fromUtf8("label_34"));

        gridLayout_7->addWidget(label_34, 3, 1, 1, 1);
        ...
        gridLayout_7->addWidget(checkBox_ignorePoseCorrection, 4, 0, 1, 1);

        label_35 = new QLabel(page_3);
        label_35->setObjectName(QString::fromUtf8("label_35"));

        gridLayout_7->addWidget(label_35, 4, 1, 1, 1);
        ...
        gridLayout_7->addWidget(checkBox_2dslam, 5, 0, 1, 1);

        label_41 = new QLabel(page_3);
        label_41->setObjectName(QString::fromUtf8("label_41"));

        gridLayout_7->addWidget(label_41, 5, 1, 1, 1);
        ...
        page_4->setGeometry(QRect(0, 0, 243, 284));
        ...
        page_5->setGeometry(QRect(0, 0, 256, 151));
    ...
    void retranslateUi(QMainWindow *DatabaseViewer)
    {
        ...
        label_optimizeFrom->setText(QApplication::translate("DatabaseViewer", "Optimize from", 0, QApplication::UnicodeUTF8));
        ...
        label_41->setText(QApplication::translate("DatabaseViewer", "2d SLAM", 0, QApplication::UnicodeUTF8));
