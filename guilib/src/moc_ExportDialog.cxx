...
static const char qt_meta_stringdata_rtabmap__ExportDialog[] = {
    "rtabmap::ExportDialog\0\0configChanged()\0"
    "getPath()\0restoreDefaults()\0"
};
...
const QMetaObjectExtraData rtabmap::ExportDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rtabmap::ExportDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rtabmap__ExportDialog,
      qt_meta_data_rtabmap__ExportDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rtabmap::ExportDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__ExportDialog))
