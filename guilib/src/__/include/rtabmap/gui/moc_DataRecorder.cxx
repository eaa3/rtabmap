...
static const char qt_meta_stringdata_rtabmap__DataRecorder[] = {
    "rtabmap::DataRecorder\0\0data\0"
    "addData(rtabmap::SensorData)\0image,depth\0"
    "showImage(cv::Mat,cv::Mat)\0"
};
...
void rtabmap::DataRecorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->addData((*reinterpret_cast< const rtabmap::SensorData(*)>(_a[1]))); break;
        case 1: _t->showImage((*reinterpret_cast< const cv::Mat(*)>(_a[1])),(*reinterpret_cast< const cv::Mat(*)>(_a[2]))); break;
        default: ;
        }
    }
}
