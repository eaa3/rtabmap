...
static const char qt_meta_stringdata_UPlotCurve[] = {
    ...
    "setData(QVector<float>,QVector<float>)\0"
    "setData(std::vector<float>,std::vector<float>)\0"
    "setData(QVector<float>)\0"
    "setData(std::vector<float>)\0"
};
...
void UPlotCurve::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 15: _t->setData((*reinterpret_cast< const QVector<float>(*)>(_a[1])),(*reinterpret_cast< const QVector<float>(*)>(_a[2]))); break;
        case 16: _t->setData((*reinterpret_cast< const std::vector<float>(*)>(_a[1])),(*reinterpret_cast< const std::vector<float>(*)>(_a[2]))); break;
        case 17: _t->setData((*reinterpret_cast< const QVector<float>(*)>(_a[1]))); break;
        case 18: _t->setData((*reinterpret_cast< const std::vector<float>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
static const char qt_meta_stringdata_UPlotLegendItem[] = {
    ...
    "moveUpRequest(UPlotLegendItem*)\0"
    "moveDownRequest(UPlotLegendItem*)\0"
    "updateStdDev()\0"
};
...
static const char qt_meta_stringdata_UPlotLegend[] = {
    ...
    "curve,\0legendItemMoved(const UPlotCurve*,int)\0"
    "removeLegendItem(const UPlotCurve*)\0"
    "item\0moveUp(UPlotLegendItem*)\0"
    "moveDown(UPlotLegendItem*)\0"
...
static const char qt_meta_stringdata_UPlot[] = {
    ...
    "updateAxis(const UPlotCurve*)\0,index\0"
    "moveCurve(const UPlotCurve*,int)\0"
};
...
void UPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->moveCurve((*reinterpret_cast< const UPlotCurve*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
