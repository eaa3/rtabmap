...
**
** Created: Mon May 18 14:44:32 2015
...
static const char qt_meta_stringdata_ObjDeletionHandler[] = {
    "ObjDeletionHandler\0\0objDeletionEventReceived(int)\0"
};
...
const QMetaObjectExtraData ObjDeletionHandler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ObjDeletionHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ObjDeletionHandler,
      qt_meta_data_ObjDeletionHandler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ObjDeletionHandler::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ObjDeletionHandler))
