...
**
** Created: Mon May 18 14:45:48 2015
...
static const char qt_meta_stringdata_MapBuilder[] = {
    "MapBuilder\0\0pauseDetection()\0data\0"
    "processOdometry(rtabmap::SensorData)\0"
    "stats\0processStatistics(rtabmap::Statistics)\0"
    "event\0handleEvent(UEvent*)\0"
};
...
void MapBuilder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->processOdometry((*reinterpret_cast< const rtabmap::SensorData(*)>(_a[1]))); break;
        case 2: _t->processStatistics((*reinterpret_cast< const rtabmap::Statistics(*)>(_a[1]))); break;
        case 3: _t->handleEvent((*reinterpret_cast< UEvent*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
