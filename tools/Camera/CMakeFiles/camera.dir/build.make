...
tools/Camera/CMakeFiles/camera.dir/main.cpp.o: tools/Camera/main.cpp
	...
	cd /home/ermano/Projects/rtabmap/tools/Camera && /usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/camera.dir/main.cpp.o -c /home/ermano/Projects/rtabmap/tools/Camera/main.cpp
...
tools/Camera/CMakeFiles/camera.dir/main.cpp.i: cmake_force
	...
	cd /home/ermano/Projects/rtabmap/tools/Camera && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /home/ermano/Projects/rtabmap/tools/Camera/main.cpp > CMakeFiles/camera.dir/main.cpp.i
...
tools/Camera/CMakeFiles/camera.dir/main.cpp.s: cmake_force
	...
	cd /home/ermano/Projects/rtabmap/tools/Camera && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /home/ermano/Projects/rtabmap/tools/Camera/main.cpp -o CMakeFiles/camera.dir/main.cpp.s
...
bin/rtabmap-camera: /opt/ros/hydro/lib/liboctomap.so
bin/rtabmap-camera: /opt/ros/hydro/lib/liboctomath.so
bin/rtabmap-camera: bin/librtabmap_core.so.0.9.0
bin/rtabmap-camera: bin/librtabmap_utilite.so.0.9.0
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_videostab.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_video.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_ts.a
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_superres.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_stitching.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_photo.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_ocl.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_objdetect.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_nonfree.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_ml.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_legacy.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_imgproc.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_highgui.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_gpu.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_flann.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_features2d.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_core.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_contrib.so.2.4.9
bin/rtabmap-camera: /opt/ros/hydro/lib/libopencv_calib3d.so.2.4.9
bin/rtabmap-camera: /usr/lib/libboost_system-mt.so
bin/rtabmap-camera: /usr/lib/libboost_filesystem-mt.so
bin/rtabmap-camera: /usr/lib/libboost_thread-mt.so
bin/rtabmap-camera: /usr/lib/libboost_date_time-mt.so
bin/rtabmap-camera: /usr/lib/libboost_iostreams-mt.so
bin/rtabmap-camera: /usr/lib/libboost_serialization-mt.so
bin/rtabmap-camera: /usr/lib/libpcl_common.so
bin/rtabmap-camera: /usr/lib/libflann_cpp_s.a
...
bin/rtabmap-camera: /usr/lib/libqhull.so
...
bin/rtabmap-camera: /opt/ros/hydro/lib/libfreenect.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libfreenect_sync.so
bin/rtabmap-camera: /usr/lib/libOpenNI2.so
bin/rtabmap-camera: /usr/lib/x86_64-linux-gnu/libdc1394.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libg2o_stuff.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libg2o_core.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libg2o_solver_csparse.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libg2o_csparse_extension.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libg2o_types_slam2d.so
bin/rtabmap-camera: /opt/ros/hydro/lib/libg2o_types_slam3d.so
bin/rtabmap-camera: /usr/lib/libcxsparse.so
...
bin/rtabmap-camera: tools/Camera/CMakeFiles/camera.dir/link.txt
	...
	cd /home/ermano/Projects/rtabmap/tools/Camera && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/camera.dir/link.txt --verbose=$(VERBOSE)
...
tools/Camera/CMakeFiles/camera.dir/clean:
	cd /home/ermano/Projects/rtabmap/tools/Camera && $(CMAKE_COMMAND) -P CMakeFiles/camera.dir/cmake_clean.cmake
.PHONY : tools/Camera/CMakeFiles/camera.dir/clean

tools/Camera/CMakeFiles/camera.dir/depend:
	cd /home/ermano/Projects/rtabmap && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/ermano/Projects/rtabmap /home/ermano/Projects/rtabmap/tools/Camera /home/ermano/Projects/rtabmap /home/ermano/Projects/rtabmap/tools/Camera /home/ermano/Projects/rtabmap/tools/Camera/CMakeFiles/camera.dir/DependInfo.cmake --color=$(COLOR)
